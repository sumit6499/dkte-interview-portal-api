...
exports.updateAdmin = exports.signUp = exports.login = void 0;
...
const login = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const existingUser = yield prisma.faculty.findFirst({
            where: { email: email },
        });
        if (!existingUser) {
...
const signUp = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const faculty = yield prisma.faculty.create({
            data: {
                name: name,
                id_card: idCardURL,
                dept: dept,
        ...
        const token = jsonwebtoken_1.default.sign({ email: faculty.email, id: faculty.id }, process.env.JWT_SECRET_KEY, { expiresIn: "1h" });
        return res.status(200).json({
            succes: true,
            data: faculty,
            token: token,
...
const updateAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const faculty = yield prisma.faculty.findFirst({
            where: {
                id: _id,
            },
        });
        if (!faculty) {
            ...
            const faculty = yield prisma.faculty.update({
                where: {
                    id: _id,
                },
                data: adminData,
