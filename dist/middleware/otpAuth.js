...
const otpAuth = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        //@ts-ignore
        req.id = decodedData === null || decodedData === void 0 ? void 0 : decodedData.id;
        next();
    }
    catch (error) {
        logger_1.winstonLogger.error(error);
        return res.status(401).json({
            success: false,
